...
### Video - [Introduction to the Professional Cloud Architect role](https://www.cloudskillsboost.google/course_templates/78/video/531930)
...
### Video - [Designing Cymbal Direct's cloud architecture](https://www.cloudskillsboost.google/course_templates/78/video/531936)
...
### Video - [Diagnostic Questions Practice Demo](https://www.cloudskillsboost.google/course_templates/78/video/531938)
...
### Video - [Provisioning a cloud solution to meet Cymbal Direct’s requirements](https://www.cloudskillsboost.google/course_templates/78/video/531944)
...
### Video - [Optimizing Cymbal Direct’s technical and business processes and procedures for the cloud](https://www.cloudskillsboost.google/course_templates/78/video/531958)
...
### Video - [Implementation, operations, and reliability at Cymbal Direct](https://www.cloudskillsboost.google/course_templates/78/video/531965)
...
### Video - [Introduction: Diagnostic questions for module 5](https://www.cloudskillsboost.google/course_templates/78/video/531966)
...
### Video - [Understand overarching goals](https://www.cloudskillsboost.google/course_templates/78/video/531973)
...
### Video - [Categorize and prioritize objectives](https://www.cloudskillsboost.google/course_templates/78/video/531975)
...
### Video - [Analyze and determine preliminary options](https://www.cloudskillsboost.google/course_templates/78/video/531976)
...
### Video - [Refine options identify solution](https://www.cloudskillsboost.google/course_templates/78/video/531977)

* [YouTube: Refine options identify solution](https://www.youtube.com/watch?v=8dy5GZAzqn8)

At this stage, it is a critical success factor to look at each of the potential solutions and refine your options. Read the documentation associated with the resources and services that you plan to use to identify each of the product’s and service’s strengths and weaknesses. Use this information to determine why you should use a product and when you shouldn’t. As you review the documentation look to see if there are other products used in conjunction with the solution you are considering. This may be a ‘pattern’ you can adopt. Pay special attention to two criteria generally present in the documentation: cost and scalability. Use the requirements from the case and the limits associated with these two criteria as guides to help you choose which product makes sense in your solution. Take a look at the best practices section in the documentation, if it is available. Check to see if there are specific best practice guides available. Review the Google Cloud Architecture Framework, to ensure your solutions consider an architecture that includes systems design, operational excellence, security, privacy, and compliance, reliability, cost optimization, and performance optimization. You may be wondering why ‘reading and knowing the best practices’ is being emphasized. As a Professional Cloud Architect it is expected you will understand what the best practices are and how to deploy them in your solution architecture. You’re expected to use that information to propose the optimal way of addressing your organization’s requirements and constraints, and to help avoid mistakes so your company, organization, or client can get the best experience possible out of Google Cloud. At this point in the case analysis process, you’ve narrowed your solutions down to the products and services you think you should use. You should read the documentation and best practice guides that apply to your environment to help you refine your options. Let’s take a look at the Dress4Win case. Dress4Win indicates it wants to improve the organization’s business agility and the speed of innovation through rapid provisioning of new resources. The case study mentions one of organization’s miscellaneous servers is a Jenkins server. Jenkins is a widely used tool, but if you are looking for a cloud-based solution or tool you should review the documentation surrounding the CI/CD products on Google Cloud. While you definitely want to devote the majority of your time to the components you think will be part of your solution, it also makes sense to spend some of your time on alternatives that you could use if something changed. Customers often will introduce a new requirement at the last minute, or they’ll inform you that they’ve chosen to make a change that invalidates your existing solution. It’s a good idea to have another option readily available, even if it is not quite as fully realized as your existing solution. Lastly, it’s a good idea to know what all or almost all of Google Cloud’s offerings are. Be prepared. For example, even if you’ve never used Memorystore before, if you were asked to describe what this resource does, you should be able to describe Memorystore as a fully managed, Redis implementation, even if you can’t provide a more in-depth description without further research or testing. As you refine your solution components, remember to use reference architectures as a resource. For example, in the case study it was noted that Dress4Win had a Jenkins server. There is a reference architecture diagram for a CI/CD pipeline architecture. It uses Spinnaker instead of Jenkins, but the documentation specifically mentions that Jenkins could be a drop-in replacement. You may not always find a drop-in solution for your entire environment, but often it is possible to take a few reference solutions and combine them together into a new solution which meets your needs or provides you with a starting point. Remember, the Cloud Architecture Center can be found on our online documentation. As you refine your options you can take an interrogatory approach to try and find flaws in your design and help you identify your final solution. You can use these questions to help point you to areas you need to address, or reasons you may need to change your design: Will this compute/storage/network design enable you to refactor your design over time? How well would this scale if you got 10x or 100x the traffic you expected? Are there big data products or services you could use now and grow into? Does your VPC network need to be accessed from somewhere else? By who? Could you implement your solution as a fully managed pipeline? How will your service be accessed from the internet? What if any/compliance requirements exist? What is a likely disaster? Would your environment survive? How do you know your service is healthy? How do you troubleshoot and fix it if it’s not? How do you deploy new versions of your service or roll them back? How would you use these questions to refine the Dress4Win potential solutions and help you determine the final solution? Would using Compute Engine for Dress4Win’s web application servers that provide microservices-based APIs and static content be scalable if you had a huge spike in traffic? Yes, probably, if you use managed instance groups. Could you scale more efficiently if you use a managed compute offering? Very probably. Using a managed compute offering would also simplify deploying new versions, and have a number of other benefits. Using a managed compute offering might be something that could be implemented in the future if not immediately. At this point, assuming you have gone through your complete list of objectives, you should have a final design. To think of this framed scientifically, you have made a series of formal observations about our requirements. You have a hypothesis for solutions that would meet our objective. You have tried to falsify your solution by interrogating to see if there are areas where the solution it falls apart and does not meet objectives. Diagramming your solution(s) as a topology can be helpful as a final step to find anything you missed, and will often be helpful in communicating your design. For the PCA Exam, this is where analyzing the case study stops. In real life, there is an additional step: stakeholder review. As a Professional Cloud Architect, after you have your solution architecture you would go back to your stakeholders and see if they agree with your design. You would iterate your design based on the feedback you receive. You could also talk to Implementation Engineers or colleagues who specialize in specific aspects of cloud architecture, such as GKE or CI/CD pipelines, and get feedback on your design. Since organizations are always evolving, your design probably will also evolve. Make sure to keep learning and reading about best practices and new solutions available, even after you pass your certification. Being a Certified Professional Cloud Architect has a lot of benefits, and you will need to recertify after two years. If you maintain your learning over that time, you won’t have to try and cram at the last minute.

### Video - [Weekly Study Goals](https://www.cloudskillsboost.google/course_templates/78/video/531978)
